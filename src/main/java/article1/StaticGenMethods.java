 ...
 * Обычно, для создания объекта используется открытый(public) конструктор. Есть и другой отличный прием - класс должен
 ...
 * Замен открытого конструктора статическим методом генерации имеет как преимущества, так и недостатки.
 *
 ...
 * Эта излишняя спецификация тсановится проблемой при возрастании сложности параметрических типов. При использовани
